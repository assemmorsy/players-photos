  ...
  <div v-if="board && players && sponcers">
    <div class="mt-3 ms-3">
      ...
      <input
        ...
        autocomplete="off"
        value="auto"
        v-model="board.namesControl"
      />
      <label
        class="btn btn-outline-success mx-md-3 ms-1 me-1"
        for="success-outlined"
        >التحكم بالاسماء تلقائيا
      </label>
      ...
      <div v-if="board.namesControl === 'manual'">
        <div
          ...
          "
        >
          <label for="name" class="form-label d-inline-block me-md-3 w-25"
            >اسم الفريق الاول</label
          >
          <input
            type="text"
            class="form-control d-inline-block"
            ...
            v-model="board.team1.manualName"
            required
          />
        </div>
        <div
        ...
        >
          ...
          <input
            ...
            name="name"
            id="name"
            v-model="board.team2.manualName"
            placeholder="اسم الفريق الثانى"
            required
          />
        </div>
      </div>
